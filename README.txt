...
All three projects now link to their live sites from the "View Project" pop-up:
- Kumbh Snan       -> https://kumbh-snan.com/
- Fashion Hood      -> https://fashion-hood.pages.dev/
- Freedom Studio    -> https://freedom-studio.pages.dev/
To change any of these later, open script.js and search for `live:`.
